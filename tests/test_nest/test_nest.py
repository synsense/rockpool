...
def test_chargeSingleNeuron():
    ...
    from nn.layers import FFIAFNest
...
def test_setWeightsIn():
    """ Test weight setting"""
    from nn.layers import FFIAFNest, RecIAFSpkInNest, RecAEIFSpkInNest
...
def test_FFToRecLayer():
    ...
    from rockpool import timeseries as ts
    from nn.layers import FFIAFNest, RecIAFSpkInNest
    from nn.networks import network as nw
    import numpy as np
...
def test_DefaultParams():
    """ Test RecIAFNest"""
    from nn.layers import RecIAFSpkInNest, FFIAFNest
    from rockpool import timeseries as ts
    from nn.networks import network as nw
    import numpy as np
