...
def test_imports():
    from rockpool.devices.xylo.xylo_a3 import PolyPhaseFIR_DecimationFilter, PDM_Microphone
...
def test_polyphase_decimation_filter():
    ...
    from rockpool.devices.xylo.xylo_a3 import PDM_Microphone, PolyPhaseFIR_DecimationFilter
