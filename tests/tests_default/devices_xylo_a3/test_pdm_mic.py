...
def test_imports():
    from rockpool.devices.xylo.syns65302.afe.pdm import DeltaSigma, MicrophonePDM
...
def test_deltasigma():
    ...
    for order in order_list:
        ...
        sig_out_Q, sig_out, sig_in_resampled, recording = ds.evolve(
            sig_in=sig_in, sample_rate=fs, record=True
        )
        ...
        sig_out_Q, sig_out, sig_in_resampled, recording = ds.evolve(
            sig_in=sig_in, sample_rate=fs_min, record=True
        )
