...
def test_ffiaf_torch():
    # - Test FFIAFTorch
    from nn.layers import FFIAFTorch
...
def test_ffiaf_spkin_torch():
    ...
    from nn.layers import FFIAFSpkInTorch
...
def test_reciaf_torch():
    ...
    from nn.layers import RecIAFTorch
    from rockpool.timeseries import TSContinuous
    import numpy as np
...
def test_reciaf_spkin_torch():
    ...
    from nn.layers import RecIAFSpkInTorch
    from rockpool.timeseries import TSEvent
    import numpy as np
...
def test_ffiaf_refr_torch():
    # - Test FFIAFTorch
    from nn.layers import FFIAFTorch
    from nn.layers import FFIAFRefrTorch
    from rockpool.timeseries import TSContinuous
    import numpy as np
...
def test_ffiaf_spkin_refr_torch():
    # - Test FFIAFSpkInTorch
    from nn.layers import FFIAFSpkInTorch
    from nn.layers import FFIAFSpkInRefrTorch
    from rockpool.timeseries import TSEvent
    import numpy as np
...
def test_reciaf_refr_torch():
    ...
    from nn.layers import RecIAFTorch
    from nn.layers import RecIAFRefrTorch
    from rockpool.timeseries import TSContinuous
    import numpy as np
...
def test_reciaf_spkin_refr_cl_torch():
    # - Test RecIAFSpkInTorch
    from nn.layers import RecIAFSpkInRefrCLTorch
    from rockpool.timeseries import TSEvent
    import numpy as np
