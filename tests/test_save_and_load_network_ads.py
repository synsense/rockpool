...
def test_it():
    ...
    def test_network_ads(nInSize, nResSize, nOutSize):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            assert(net.lyrRes.discretize_dynapse == True), "discretize_dynapse is not equal"
            assert(net.lyrRes.num_synapse_states == -1), "num_synapse_states is not as expected"
