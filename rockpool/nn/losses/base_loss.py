"""
    ...
    All loss classes need to implement a forward method. In contrast to torch losses (where the loss is typically
    ...
    weighted sum of the two: loss = loss_target + weight_nontarget * loss_nontarget
