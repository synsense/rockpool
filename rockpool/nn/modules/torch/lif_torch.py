        ...
        **kwargs,
        ...
        if self.leak_mode == "taus":
            ...
            if any([alpha,beta,dash_mem,dash_syn]):
                ...
                raise ValueError('current leak mode is set to taus and only parameters from this family can be directly initilized (eg: tau_mem and tau_syn)' )
            ...
            if any([tau_mem,tau_syn,dash_mem,dash_syn]):
                ...
                raise ValueError('current leak mode is set to decays and only parameters from this family can be directly initilized (eg: alpha and beta)' )
            ...
            if any([alpha,beta,tau_mem,tau_syn]):
                raise ValueError('current leak mode is set to bitshifts and only parameters from this family can be directly initilized (eg: dash_mem and dash_syn)' )
