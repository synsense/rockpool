...
class DynapSim(JaxModule):
    ...
    def __init__(
        ...
        Igain_syn: Optional[np.ndarray] = dcurrents["Igain_ampa"],
        ...
        **kwargs,
        ...
        self.Igain_syn = __parameter(Igain_syn)
        ...
        self.Itau_syn = __parameter(Itau_syn)
    ...
    def evolve(
        ...
        def forward(
            ...
            ws_rec = jnp.dot(self.md.w_rec.T, spikes).T  # Nrec
