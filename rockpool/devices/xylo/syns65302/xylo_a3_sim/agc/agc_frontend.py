...
from rockpool.devices.xylo.syns65302.xylo_a3_sim.agc.amplifier import Amplifier
from rockpool.devices.xylo.syns65302.xylo_a3_sim.agc.adc import ADC
from rockpool.devices.xylo.syns65302.xylo_a3_sim.agc.envelope_controller import (
    EnvelopeController,
)
from rockpool.devices.xylo.syns65302.xylo_a3_sim.agc.gain_smoother import GainSmootherFPGA

from rockpool.devices.xylo.syns65302.xylo_a3_sim.agc.xylo_a3_agc_specs import (
    AUDIO_SAMPLING_RATE,
)
...
class AGC_ADC:
    def __init__(
        ...
        # NOTE: oversampling of the modules could be arbitrary (up to the caveat that it may cause frequency shift in the signal).
        # However, the simulation oversampling should be always an integer! So that the amplifier module can be fed/run an integer-times faster than the other modules.
    ...
    def evolve(
        ...
        Returns:
            np.ndarray: the output of ADC or Gain-Smoother if it is in the loop.
        """
