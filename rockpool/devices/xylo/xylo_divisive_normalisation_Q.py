...
#
# Note: this file is similar to xylo_divisive_normalisation.py but it implements smoothing filter with bad quantisation.
# -----------------------------------------------------------
...
class DivisiveNormalisation(Module):
    ...
    def evolve(
        ...
        for t in range(E.shape[0]):
            ...
            # the bad version in the current design
            M[t + 1, :] = (E[t, :]>>self.bits_shift_lowpass) + M[t, :] - (M[t, :] >> self.bits_shift_lowpass)
