...
class IMUIFSamna(Module):
    ...
    .. Warning::
        ...
        :py:class:`.IMUIFSamna` blocks FPGA access to the IMU sensor on the Xylo HDK, if ``prerecorded_imu_inpu = False``, becuase it connects the IMU sensor directly to Xylo.
