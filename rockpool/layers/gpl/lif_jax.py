...
class RecLIFJax(Layer, JaxTrainer):
    ...
    This layer can be used to implement gradient-based learning systems, using the JAX-provided automatic differentiation functionality of `jax.grad`. See :py:meth:`~JaxTrainer.train_output_target` for information on training.
