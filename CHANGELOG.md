...
* Initial module structure for Xylo-IMU support
  ...
  - IMU preprocessing interface
    - `Quantizer` , `RotationLookUpTable` , `JSVD` , `SubSpace` , `SampleAndHold` , `RotationRemoval` , `BandPassFilter` , `FilterBank` , `HalfWaveRectifier` , `FullWaveRectifier` are implemented
