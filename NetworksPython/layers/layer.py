...
class Layer(ABC):
    ...
    def _expand_to_shape(
        self, oInput, tupShape: tuple, sVariableName: str = "input", bAllowNone: bool = True
    ) -> np.ndarray:
        """
    ...
    def _expand_to_weight_size(
        ...
        return self._expand_to_shape(oInput, (self.nSize, self.nSize), sVariableName, bAllowNone)
